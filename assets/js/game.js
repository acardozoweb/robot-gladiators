...
var fightOrSkip = function () {
  ...
  if (promptFight === "skip") {
    ...
    if (confirmSkip) {
      ...
      // subtract money from playerMoney for skipping, without letting go into the negative
...
var fight = function (enemy) {
  while (playerInfo.health > 0 && enemy.health > 0) {
    ...
    while (playerInfo.health > 0 && enemy.health > 0) {
      // ask player if they'd like to fighty or skip using fightOrSkip function
      if (fightOrSkip()) {
...
var shop = function () {
  ...
  // show prompt responses as integers
